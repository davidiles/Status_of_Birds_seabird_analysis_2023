...
for (run in 1:100){
  ...
  # Additive variance different among colonies
  ...
  for (i in 1:ncolony){
    ...
    # Simulate 1-3 additional surveys
    survey_years <- c(survey_years, sample(11:(nyears-11),sample(1:5,1)))
  ...
  fit_samples = reshape2::melt(out$sims.list$etapred) %>%
